...
function Hero() {
  return (
    <div className="container">
      ...
      <div className="row p-5 mt-5 border-top fs-5 text-muted" style={{lineHeight:"1.8"}}>
        ...
        <div className="col-6 p-5">
            ...
            <p className="mb-4">And yet, we are always up to something new every day. Catch up on the latest updates on our blog or see what the media is saying about us.
            </p>
        </div>
      </div>
    </div>
